...
def page_eda(raw_df, df):
    st.markdown('<div class="sub-header">📊 Exploratory Data & Trend Analysis</div>', unsafe_allow_html=True)
    ...
    # 4. Trend Analysis (from page_data_analysis merged here)
    st.markdown("---")
    st.subheader("📊 Trend Analysis (from processed dataset)")
