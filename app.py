...
def page_overview(df, metrics):
    ...
    c4.metric("Avg Price", f"${summary['avg_price']:.2f}" if summary['avg_price'] is not None else "N/A")
    c4.metric("Avg Rating", f"{summary['avg_rating']:.2f}" if summary['avg_rating'] is not None else "N/A")
