...
def page_overview(df, metrics):
    ...
    avg_price = df['price_orig'].mean() if 'price_orig' in df.columns else df['price'].mean()
    avg_rating = df['rating_orig'].mean() if 'rating_orig' in df.columns else df['rating'].mean()
