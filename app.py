...
def page_overview(df, metrics):
    ...
    unique_colors = summary['unique_colors']
    trending_items = summary['trending_items']
    unique_styles = summary['unique_styles']
    trending_ratio = summary['trending_ratio']
    unique_brands = summary['unique_brands']
    avg_price = summary['avg_price']
    avg_rating = summary['avg_rating']

    trending_ratio_str = f"{trending_ratio*100:.2f}%"
    ...
    if not trending.empty:
        top_color = trending['color'].mode().iloc[0]
        top_style = trending['style attributes'].mode().iloc[0]
        top_brand = trending['brand'].mode().iloc[0]
